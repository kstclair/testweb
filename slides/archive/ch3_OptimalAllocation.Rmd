---
title: "Ch. 3: Optimal sample size allocation"
...
- Highest allocation for strata with high variability $S_{h}$, large size $N_{h}$, or low costs $c_{h}$.
]
...
$$S_h = \sqrt{p_h (1-p_h)}$$
where $p_{h}$ is an educated guess at the population proportion within stratum $h$.
]
