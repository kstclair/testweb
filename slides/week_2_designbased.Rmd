...
## Small example
Suppose we have $N=3$ lakes in a town. We are asked to estimate the total number residents who live around the lakes. 
...
We want to estimate $t$ using a sample of size $n=2$ lakes. 
...
Under **design 1**, what is the sampling distribution of $\hat{t}$? (hint: it will be a **discrete probability mass function**)
...
Under **design 1**,  what is the (estimator) bias of $\hat{t}$?

---

## Small example

Under **design 1**,  what is the SD of $\hat{t}$? 
...
Under **design 1**,  what is the MSE of $\hat{t}$?
...
Write down the sampling distribution of $\hat{t}$ under design 2 and computed the expected value, bias, SD and MSE.
...
**Design 3**: Put three pieces of paper in a hat labeled 1-3, draw 2 pieces at random, without replacement (Simple Random Sample)
...
Write down the sampling distribution of $\hat{t}$ under design 3 and computed the expected value, bias, SD and MSE.
...
**Sampling distribution** of $\hat{t}$ under **design 3**
...
$\hat{t}$ | 24 | 27 | 30 | 33 | 36 
--------- | --- | --- | --- | --- | ---
Probability | 0 | 1/3 | 1/3 | 1/3 | 0


--

- Expected value: $E(\hat{t}) =   30$
